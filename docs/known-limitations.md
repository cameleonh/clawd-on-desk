...
| **No uninstall script** | No automated script to remove hooks from Claude Code, Copilot, Cursor, Gemini, Kiro, or opencode configurations. Users must manually clean up `~/.claude/settings.json` and other config files. |
